 ...
 */
package com.framework.exocet.modules.act.service.ext;
...
import com.framework.exocet.modules.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.framework.exocet.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.framework.exocet.modules.sys.entity.User(null, userId)))){
