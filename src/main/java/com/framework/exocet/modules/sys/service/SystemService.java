 ...
 */
package com.framework.exocet.modules.sys.service;
...
import org.framework.exocet.core.security.Digests;
import org.framework.exocet.core.security.shiro.session.SessionDAO;
import org.framework.exocet.core.web.Servlets;
import org.framework.exocet.utils.CacheUtils;
import org.framework.exocet.utils.Encodes;
...
import com.framework.exocet.common.service.BaseService;
import com.framework.exocet.common.service.ServiceException;
import com.framework.exocet.modules.sys.dao.MenuDao;
import com.framework.exocet.modules.sys.dao.RoleDao;
import com.framework.exocet.modules.sys.dao.UserDao;
import com.framework.exocet.modules.sys.entity.Menu;
import com.framework.exocet.modules.sys.entity.Office;
import com.framework.exocet.modules.sys.entity.Role;
import com.framework.exocet.modules.sys.entity.User;
import com.framework.exocet.modules.sys.security.SystemAuthorizingRealm;
import com.framework.exocet.modules.sys.utils.LogUtils;
import com.framework.exocet.modules.sys.utils.UserUtils;
...
public class SystemService extends BaseService implements InitializingBean {
	...
	public Page<User> findUser(Page<User> page, User user) {
		...
		user.setPage(page);
		// 执行分页查询
		List<User> ul = userDao.findList(user);
		page.setList(ul);
		return page;
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By http://exocet.com\r\n");
		sb.append("\r\n======================================================================\r\n");
