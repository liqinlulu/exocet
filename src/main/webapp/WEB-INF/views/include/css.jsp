...
<c:set var="ctitle" value="XXX管理系统"/>
<!--[if lt IE 8]>
    <meta http-equiv="refresh" content="0;ie.html" />
    <![endif]-->
    
<link href="${ctx}/resources/css/bootstrap.min.css?v=3.3.5" rel="stylesheet">
<link href="${ctx}/resources/css/plugins/chosen/chosen.css" rel="stylesheet">
...
<!--<link href="${ctx}/resources/css/plugins/chosen/chosen.css" rel="stylesheet">-->
<link href="${ctx}/resources/js/plugins/chosen1.4.2/chosen.css" rel="stylesheet">

<link href="${ctx}/resources/css/plugins/iCheck/custom.css" rel="stylesheet">
<!--<link href="${ctx}/resources/css/plugins/awesome-bootstrap-checkbox/awesome-bootstrap-checkbox.css" rel="stylesheet"> -->
