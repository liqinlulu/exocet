$(function() {
    ...
    function e(e) {
        ...
        else if (i <= s - $(e).outerWidth(true) - $(e).next().outerWidth(true)) {
            if (s - $(e).next().outerWidth(true) > i) {
                r = a;
                for (var o = e; r - $(o).outerWidth() > $(".page-tabs-content").outerWidth() - s;) r -= $(o).prev().outerWidth(),
                o = $(o).prev()
            }
        } else a > s - $(e).outerWidth(true) - $(e).prev().outerWidth(true) && (r = a - $(e).prev().outerWidth(true));
    ...
    function a() {
        ...
        i = $(".content-tabs").outerWidth(true) - a,
        n = 0;
        if ($(".page-tabs-content").width() < i) return false;
        for (var s = $(".J_menuTab:first"), r = 0; r + $(s).outerWidth(true) <= e;) r += $(s).outerWidth(true),
        s = $(s).next();
        if (r = 0, t($(s).prevAll()) > i) {
            for (; r + $(s).outerWidth(true) < i && s.length > 0;) r += $(s).outerWidth(true),
            s = $(s).prev();
            n = t($(s).prevAll())
        }
        $(".page-tabs-content").animate({
    ...
    function i() {
        ...
        for (var s = $(".J_menuTab:first"), r = 0; r + $(s).outerWidth(true) <= e;) r += $(s).outerWidth(true),
        s = $(s).next();
        for (r = 0; r + $(s).outerWidth(true) < i && s.length > 0;) r += $(s).outerWidth(true),
        s = $(s).next();
        n = t($(s).prevAll()),
    ...
    function n() {
        ...
        var n = true;
        if (undefined == t || 0 == $.trim(t).length) {
            return false;
        }
        if ($(".J_menuTab").each(function() {
            var tt = $(this).data("id") == t ? ($(this).hasClass("active") || ($(this).addClass("active").siblings(".J_menuTab").removeClass("active"), e(this), $(".J_mainContent .J_iframe").each(function() {
            ...
            var r = '<iframe class="J_iframe" name="iframe' + a + '" width="100%" height="100%" src="' + href + '?v=4.0" frameborder="0" data-id="' + t + '" seamless></iframe>';
        ...
        if ($(this).parents(".J_menuTab").hasClass("active")) {
            if ($(this).parents(".J_menuTab").next(".J_menuTab").size()) {
                ...
                $(".J_mainContent .J_iframe").each(function() {
                    return $(this).data("id") == i ? ($(this).show().siblings(".J_iframe").hide(), false) : void 0
                });
                ...
                $(".J_mainContent .J_iframe").each(function() {
                    return $(this).data("id") == t ? ($(this).remove(), false) : void 0;
                })
            }
